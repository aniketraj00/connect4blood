...
class RecipientSettingsFAQs: Fragment() {

    private lateinit var recyclerFaqs: RecyclerView
    private lateinit var recyclerFaqsLM: RecyclerView.LayoutManager
    ...
    override fun onCreateView(
        ...
        activity?.let {
            Utils
                .getInstance()
                .enableBackButton((it as RecipientDashboard).supportActionBar, "FAQs")
        }
    ...
    override fun onDestroyView() {
        ...
        Utils
            .getInstance()
            .disableBackButton((requireActivity() as RecipientDashboard).supportActionBar)
    }

    companion object {
        fun newInstance(): RecipientSettingsFAQs {
            val fragment = RecipientSettingsFAQs()
            val args = Bundle()
